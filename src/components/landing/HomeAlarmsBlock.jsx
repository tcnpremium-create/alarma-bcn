...
const KITS = [
  {
    ...
    items: [
      ...
      "2 detectores de movimiento MotionCam (verificación visual)",
      "Detector magnético para puerta principal",
      "Teclado numérico KeyPad Plus",
  ...
  },
  {
    ...
    items: [
      "Hub Ajax (central de control)",
      "4 detectores de movimiento con cámara integrada",
      "2 detectores magnéticos (puertas/ventanas)",
      "2 teclados KeyPad Plus",
      "Sirena exterior StreetSiren",
      "Sirena interior HomeSiren",
  ...
  },
  {
    ...
    subtitle: "Blindaje integral para comunidades y fincas",
    price: "desde 799 €",
    items: [
      "Hub+ Ajax (hasta 200 dispositivos)",
      "8 detectores de movimiento MotionCam",
      "4 detectores magnéticos perimetrales",
      "3 teclados KeyPad en zonas de acceso",
      "Sirena exterior de alta potencia",
      "2 sirenas interiores",
      "Aviso directo a Policía verificado",
      "Gestión multiusuario (vecinos y administrador)",
