  ...
  return (
    <section className="py-16 sm:py-20 bg-white">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#1A1A2E] mb-6 tracking-tight leading-tight">
          Instalación Profesional de Cámaras de Seguridad en Barcelona
        </h1>
