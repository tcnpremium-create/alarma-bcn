...
export default function SistemasAlarma() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#fff" }}>
      ...
      {/* ── 2. KITS DE ALARMA — justo después del Hero ── */}
      <section style={{ background: "#0F1923", padding: "52px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            <span style={{ fontSize: 11, fontWeight: 700, color: "#E53E3E", letterSpacing: "0.12em", textTransform: "uppercase" }}>Kits de Alarmas Ajax — Precios Transparentes</span>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
            {ALARM_KITS.map((kit, i) => (
              <div key={kit.id} style={{
                ...
                <h3 style={{ color: "#fff", fontSize: 15, fontWeight: 800, margin: "0 0 4px", lineHeight: 1.3 }}>{kit.title}</h3>
                <p style={{ color: "#64748B", fontSize: 11, margin: "0 0 16px", lineHeight: 1.4 }}>{kit.subtitle}</p>
