...
export default function AlarmasLleida() {
  return (
    <CityLandingTemplate
      ...
      intro={`Instalamos alarmas AJAX y cámaras de videovigilancia 4K en Lleida y toda la comarca. Garantía de ${businessStats.warrantyYears} años y mantenimiento incluido en todos los sistemas.`}
      lat={41.6176}
      lng={0.6200}
